                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4 text-dark" style="background: rgba(255, 255, 255, 0.159); backdrop-filter: blur(2px);">
                                <div class="card-body text-center">
                                    <img src="../../images1/person_1.jpg" alt="avatar" class="rounded-circle img-fluid" style="width: 150px; height:148px">
                                    <h5 class="my-3 text-dark ">Ahmad </h5>
                                    <p class="text-muted mb-1">Full Stack Developer</p>
                                    <p class="text-muted mb-4">Bay Area, San Francisco, CA</p>
                                    <div class="d-flex justify-content-center mb-2">
                                        
                                        <button type="button" class="btn btn-primary btn-outline-primary mx-1" data-bs-toggle="modal" data-bs-target="#exampleModal">Profile settings</button>
                            ...
                            <div class="card mb-4 text" style="background: rgba(255, 255, 255, 0.159); backdrop-filter: blur(2px);">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">eman </p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">zarqa</p>
                                        </div>
                                    </div>
                                    ...
                                    <table id="mytable" class="table table-bordred table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="text">
                                                    ...
                                                    <td class="text"><button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal5"> Confirm Requiest</button></td>
