        ...
        <div class="col-lg-4">
            <div class="card mb-4 text-dark" style="background: rgba(255, 255, 255, 0.159); backdrop-filter: blur(2px);">
                <div class="card-body text-center">
                    ...
                    <h5 class="my-3 text-dark ">Name </h5>
                    <p class="text-muted mb-1">City</p>
                    <p class="text-muted mb-4">Address</p>
                    <div class="d-flex justify-content-center mb-2">
                        
                        <button type="button" class="btn btn-primary btn-outline-primary mx-1" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit Profile</button>
